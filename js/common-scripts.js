(function ($) {
    ...
    $(function () {
        ...
        if($(window).width() > 480){
            ...
            if ($('#individual-news-card-slider').length) {
                $('#individual-news-card-slider').slick({
                    speed: 500,
                    slidesToShow: 4,
                    slidesToScroll: 1,
                    autoplay: false,
                ...
                $(window).on('resize', function () {
                    $('#individual-news-card-slider').slick('resize');
                });
            }
        ...
        if($(window).width() < 481){
            ...
            if ($('#individual-news-card-slider').length) {
                window._ = new Glider(document.querySelector('#individual-news-card-slider'), {
        ...
        $('.flag-dropdown').click(function(e){
            e.stopPropagation();
            $('.country-select').toggleClass('country-icon')
        })
        
        $('body').click(function(){
            $('.country-select').removeClass('country-icon')
        })
